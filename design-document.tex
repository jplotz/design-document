...
Bootstrap simplifies the process of designing a website with REACT, allowing the developer to focus on functionality rather than asthetic.


During research, one of our developers found custom bootstrap themes that would help offset the non-flexable nature of bootstrap.
...
Here are some theme designs that we decided on (note: these themes are subject to change as we continue developement):
\begin{itemize}
...
If the design that we are looking for isn't available in Bootswatch, we plan to customize the SCSS files provided by Bootswatch to better fit our desired asthetic.
...
We are fully equipped to continue the development cycle through SD2 while fulfillng our MVP.
