...
\diagram{AD-system-overview.png}{System Overview}{fig:systemOverview}
...
\begin{itemize}
    \item Bootswatch Cyborg: Figure 1
    \item Bootswatch Lux: Figure 2
    \item Bootswatch Zephyr: Figure 3
    \item Bootswatch Pulse: Figure 4
\end{itemize}
\begin{figure}[H]
  \centering
...
\begin{itemize}
	...
	\item SEO
\end{itemize}
This is an example of what a lighthouse report looks like:

\includegraphics[keepaspectratio,width=\textwidth]{lighthouse.png}
...
\diagram{WADT_Use_Case.pdf}{WADT Web Application Use Case Diagram}{fig:usecase}
...
\diagram{AD-deploying-containers.png}{Container Deployment Activity Diagram}{fig:deployContainer}
...
\diagram{AD-interacting-w-containers.png}{Interacting with Containers}{fig:interactContainers}
...
The figure \ref{fig:cleanup} describes the cleanup process that occurs when a container session ends.

\diagram{AD-container-cleanup.png}{Container Cleanup}{fig:cleanup}
