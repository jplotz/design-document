...
\begin{itemize}
    ...
    \item \textbf{Weeks 2–4 (Jan 19 – Feb 8):} Begin implementation of container management features (deploy, stop, restart, reset) and establish stable frontend-backend integration
    \item \textbf{Weeks 5–7 (Feb 9 – Mar 1):} Deploy and test first vulnerable web application, validate UI interactions and backend functionality
    \item \textbf{Weeks 8–10 (Mar 2 – Mar 22):} Expand system to include all planned web applications, begin integration testing and security validation
    \item \textbf{Weeks 10–12 (Mar 23 – Apr 12):} Performance testing, get feedback from sponsor, implement stretch goals
    \item \textbf{Weeks 12–14 (Apr 13 – Apr 26):} Implement instructor features, final touches, and work on Final Design Document
    \item \textbf{Week 15 (Apr 27):} Final presentation and Design Document
\end{itemize}
\printbibliography
